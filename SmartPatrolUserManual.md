...
| 頁面 | 圖示 | 功能說明 |
|------|------|----------|
| Dashboard | ![alt text](images/image-149.png) | 系統總覽、即時狀態與訊息列表 |
| Equipment Management | ![alt text](images/image-150.png) | 設備清單、ROI 視窗、Cupola360 視角與故障/API 設定 |
| CFX Configuration | ![alt text](images/image-151.png) | CFX/RabbitMQ 連線、佇列與記錄設定 |
| User Management | ![alt text](images/image-152.png) | 使用者與權限管理（可能預設隱藏） |
| Footer | ![alt text](images/image-153.png) | `Settings`、`Login`、`Logout`、使用者資訊 |
...
| 項目 | 圖示 | 說明 |
|------|------|------|
| 設備總數 | ![alt text](images/image-76.png) | 系統中註冊的設備總數量 |
| 啟用數量 | ![alt text](images/image-77.png) | 目前啟用狀態的設備數量 |
| 警告 | ![alt text](images/image-78.png) | 系統警告狀態數量 |
| 錯誤 | ![alt text](images/image-79.png) | 系統錯誤狀態數量 |
...
**CFX Service**
  ...
  | 項目 | 圖示 | 說明 |
  |------|------|------|
  | 連線狀態 | ![alt text](images/image-82.png) | CFX服務的連線狀態 |
  | 訊息數 | ![alt text](images/image-81.png) | 已處理的訊息總數 |
  | Uptime | ![alt text](images/image-83.png) | 服務運行時間 |
  | 訂閱佇列數 | ![alt text](images/image-84.png) | 目前訂閱的佇列數量 |
...
| 項目 | 圖示 | 說明 |
|------|------|------|
| Last Sync | ![alt text](images/image-86.png) | 最後同步時間 |
| Last Error | ![alt text](images/image-87.png) | 最後錯誤狀態 |
...
| 項目 | 圖示 | 說明 |
|------|------|------|
| 設備名稱 | ![alt text](images/image-89.png) | 顯示設備的名稱標識 |
| 當前燈號 | ![alt text](images/image-90.png) | 設備目前的燈號狀態指示 |
| WISE-S100 通道狀態 | ![alt text](images/image-91.png) | 各通道的詳細狀態顯示 |
...
| 功能 | 圖示 | 功能說明 |
|------|------|----------|
| 搜尋設備列表 | ![alt text](images/image-70.png) | 快速搜尋並篩選設備列表中的項目 |
| 新增設備 | ![alt text](images/image-71.png) | 建立新的設備項目 |
| 刪除選取設備 | ![alt text](images/image-72.png) | 移除目前選取的設備 |
| 儲存變更 | ![alt text](images/image-73.png) | 保存對設備設定的所有修改 |
| 更多選項 | ![alt text](images/image-74.png) | 展開額外功能選單 |

其中，![alt text](images/image-74.png) 有以下功能

| 功能 | 圖示 | 功能說明 |
|------|------|----------|
| Import | ![alt text](images/image-93.png) | 匯入設備設定檔案 |
| Export | ![alt text](images/image-95.png) | 匯出當前設備設定為檔案 |
| Export to Event Api | ![alt text](images/image-96.png) | 匯出設備資料至事件 API |
| Push to Cupola360 | ![alt text](images/image-97.png) | 推送設備設定到 Cupola360 系統 |
...
| 功能 | 圖示 | 說明 |
|------|------|------|
| 拖曳 | ![alt text](images/image-100.png) | 可拖曳調整設備在列表中的順序 |
| 啟用開關 | ![alt text](images/image-101.png) | 切換設備的啟用/停用狀態 |
| 設備名稱 | ![alt text](images/image-102.png) | 顯示設備的識別名稱 |
...
| 功能 | 圖示 | 說明 |
|------|------|------|
| 新增超連結 | ![alt text](images/image-107.png) | 新增連結項目到列表中 |
| 刪除超連結 | ![alt text](images/image-110.png) | 移除選取的連結項目 |
| 超連結列表 | ![alt text](images/image-109.png) | 顯示目前設定的連結清單 |
...
| 功能 | 圖示 | 說明 |
|------|------|------|
| 新增Sub ROI | ![alt text](images/image-112.png) | 新增子區域項目到列表中 |
| 刪除Sub ROI | ![alt text](images/image-113.png) | 移除選取的子區域項目 |
| Sub ROI列表 | ![alt text](images/image-114.png) | 顯示目前設定的子區域清單，包含名稱、類型、內容及可視狀態 |
...
| 測試動態事件 | ![alt text](images/image-117.png) | 送出 Dynamic Event 進行測試 |
| 結束事件測試 | ![alt text](images/image-118.png) | 送出 1ms 結束事件 |
...
| 項目 | 圖示 | 說明 |
|------|------|------|
| 應用 CFX | ![alt text](images/image-120.png) | 啟用或停用 CFX 功能 |
...
| 項目 | 圖示 | 說明 |
|------|------|------|
| 啟用 WISE-S100 | ![alt text](images/image-122.png) | 啟用或停用 WISE-S100 功能 |
...
| 功能 | 圖示 | 說明 |
|------|------|------|
| 新增API請求 | ![alt text](images/image-124.png) | 新增API動作項目到列表中 |
| 刪除API請求 | ![alt text](images/image-125.png) | 移除選取的API動作項目 |
| API列表 | ![alt text](images/image-127.png) | 顯示目前設定的API清單，包含名稱、方法、網址及啟用狀態 |
...
| 功能 | 圖示 | 說明 |
|------|------|------|
| 啟動CFX服務 | ![alt text](images/image-130.png) | 啟動 CFX 連線服務 |
| 停止CFX服務 | ![alt text](images/image-131.png) | 停止 CFX 連線服務 |
| 重啟CFX服務 | ![alt text](images/image-132.png) | 重新啟動 CFX 連線服務 |
| 儲存設定 | ![alt text](images/image-134.png) | 保存當前的 CFX 設定變更 |
| 匯入設定 | ![alt text](images/image-135.png) | 從檔案匯入 CFX 設定 |
| 匯出設定 | ![alt text](images/image-136.png) | 將當前設定匯出為檔案 |
| 檢查設定 | ![alt text](images/image-137.png) | 驗證 CFX 設定的正確性 |
| 回覆為預設值 | ![alt text](images/image-138.png) | 重置所有設定為系統預設值 |

##### 設定與 CFX 連線參數說明：
| 設定項目 | 圖示 | 說明 |
|----------|------|------|
| Enable CFX | ![alt text](images/image-128.png) | 啟用或停用 CFX 連線功能的開關，設定為 true 時開啟 CFX 通訊 |
...
| Reconnect Interval | ![alt text](images/image-129.png) | 自動重連的時間間隔，單位通常為秒 |
...
| 功能 | 圖示 | 說明 |
|------|------|------|
| 新增QUEUE | ![alt text](images/image-140.png) | 新增RabbitMQ佇列項目到列表中 |
| 修改QUEUE | ![alt text](images/image-141.png) | 編輯選取的佇列設定 |
| 刪除QUEUE | ![alt text](images/image-142.png) | 移除選取的佇列項目 |
| 當前佇列列表 | ![alt text](images/image-143.png) | 顯示目前設定的RabbitMQ佇列清單，包含啟用狀態、名稱、佇列名稱及描述 |
...
| 功能 | 圖示 | 說明 |
|------|------|------|
| 新增使用者 | ![alt text](images/image-144.png) | 新增使用者帳戶 |
| 編輯使用者 | ![alt text](images/image-145.png) | 編輯選取的使用者資訊 |
| 重設密碼 | ![alt text](images/image-146.png) | 重設使用者密碼 |
| 刪除使用者 | ![alt text](images/image-147.png) | 刪除選取的使用者 |
| 重新整理 | ![alt text](images/image-148.png) | 重新整理使用者列表 |
...
| 步驟 | 操作說明 |圖示|
|------|----------|--|
| 1 | 確認將 WISE-S100 正確的安裝到三色燈上 | ![alt text](images/image-174.png) |
| 2 | 燈號變化時使用 `open modscan` 等工具讀取 40017 ~ 40024| ![alt text](images/image-176.png) |
| 3 | 將結果以逗號為分隔填入對應欄位 (例如：1,2,3) | ![alt text](images/image-177.png) |
